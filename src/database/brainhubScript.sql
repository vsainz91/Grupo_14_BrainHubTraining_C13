...
VALUES('Curso Completo de Ingl�s: Iniciaci�n', 3500, 'Curso completo de ingl�s para dominar la gram�tica, traducci�n, conversaci�n, vocabulario, pronunciaci�n y mucho m�s.', 'Mark Thompson', 16, 28, 2, 1, NULL);
INSERT INTO brainhub_db.courses
(name, price, description, instructor, practice_time, lessons, content_hours, category_id, courses_images_id)
